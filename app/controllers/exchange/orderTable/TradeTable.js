...
import { filterTrade } from '$store/parses/tradeRecord';
...
class TradeTable extends Component {
  ...
  render() {
    ...
    return (
      <Table data={filterTrade(records)} columns={columns} />
    )
  }
}
...
export default connect(mapState, mapDispatch)(injectIntl(TradeTable))
